    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 py-8 text-justify ">
        ...
        <p className="text-xl dark:text-gray-300 text-gray-700 mb-6">
          Task Tracker is a user-friendly and efficient task management
          application designed to help you stay organized and boost your
          productivity. Here's why you'll love using Task Tracker:
        </p>
        <ul className="list-disc text-lg list-inside dark:text-gray-300 text-gray-700 mb-6 pl-4">
          ...
          <li>
            Stay on top of your deadlines and never forget important tasks.
          </li>
        ...
        <h2 className="text-2xl font-semibold dark:text-teal-400 text-teal-600 mb-4">
          Technology Stack
        </h2>
        <p className="text-lg dark:text-gray-300 text-gray-700 mb-6">
          Task Tracker is built using a modern technology stack, ensuring
        ...
        <p className="text-lg dark:text-gray-300  text-gray-700 mb-6">
          Getting started with Task Tracker is easy! Follow these simple steps
        ...
        <p className="text-lg dark:text-gray-300 text-gray-700 mb-6">
          Task Tracker is designed to help you manage your tasks efficiently and
          make your daily life more organized. Try it today and experience the
          difference!
        </p>
      </div>
    </div>
